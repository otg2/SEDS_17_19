...
public class Jabeja {
  ...
  private void sampleAndSwap(int nodeId) {
    ...
    if (config.getNodeSelectionPolicy() == NodeSelectionPolicy.HYBRID
      ...
      //partner = anneal(nodeId, getNeighbors(nodep));
    }
    ...
    if (config.getNodeSelectionPolicy() == NodeSelectionPolicy.HYBRID
      ...
      if(partner == null){
          ...
          //partner = anneal(nodeId, getSample(nodeId));
      }
    }

    // swap the colors
    // TODO
      if(partner != null && nodep != partner){
        if(partner.getColor() != nodep.getColor()){
	...
	// not used
  public String swapHandshake(Node nodep, Node nodeq){
  ...
  public Double cost(Node nodeq, Node nodep){
    int dpq = getDegree(nodep, nodeq.getColor());
    int dqp = getDegree(nodeq, nodep.getColor());
    return Math.pow(dpq, config.getAlpha()) + Math.pow(dqp, config.getAlpha());
